...
let package = Package(
	...
	dependencies: [
       // .package(name: "java_swift", url: "https://github.com/readdle/java_swift", .upToNextMinor(from: "2.2.2")),
...
//		.package(path: "../swift-java"),
       // .package(name: "JavaCoder", url: "https://github.com/readdle/swift-java-coder", from: "1.1.0")
